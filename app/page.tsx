                ...
                <ul id="bottom">
                    <li>
                        <a href="http://www.edna.edu.au/" tabIndex={15}>
                            <img style={{ border: "0px" }} src="images/edna_logo.gif"
                                alt="EdNA Online" height="81" width="84"
                                title="Education Network Australia (EdNA) has determined Typeonline to be a resource useful for teaching and learning." /></a>
                    </li>
                    <li><img style={{ border: "0px" }} src="images/ngfl.gif"
                        alt="National Grid for Learning" height="38" width="108"
                        title="Typeonline is part of the National Grid for Learning (NGfL)." /></li>
                    <li><img height="31" width="88" src="images/wcag1AA.gif"
                        ...
                        alt="Level AA conformance icon, 
            W3C-WAI Web Content Accessibility Guidelines 1.0" /></li>
                </ul>
